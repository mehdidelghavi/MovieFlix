    ...
    <section class="panel-form-container">
        <div class="panel-form-inner">
            <div class="panel-form-control">
                ...
                @endif
                <form id="user-login" name="user-login" action="{{ route('panel.register.do') }}" class="panel-form" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-control">
                        <input type="text" required="required" id="name" name="name">
                        <label class="form-legend" for="name">نام</label>
                    </div>
                    <div class="form-control">
                        <input type="text" required="required" id="family" name="family">
                        <label class="form-legend" for="family">نام خانوادگی</label>
                    </div>
                    <div class="form-control">
                        <input type="text" required="required" id="userid-input" name="email">
                        <label class="form-legend" for="userid-input">ایمیل</label>
                    </div>
                    <div class="form-control">
                        <input type="password" required="required" id="userpsw-input" name="password">
                        <label class="form-legend" for="userpsw-input">رمز عبور</label>
                    ...
                    <div class="form-control">
                        ...
                        <label class="form-legend" for="family">تصویر پروفایل</label>
                    </div>
                    <button class="submit-authentication" type="submit" id="submit-auth">ثبت نام</button>

                <div class="auth-link form-control">
                    <a class="forgot-password" href="{{ route('panel.login') }}">ثبت نام کرده اید؟ ورود به پنل</a>
                </div>
