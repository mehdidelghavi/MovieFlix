    ...
    <section class="panel-form-container">
        <div class="panel-form-inner">
            <div class="panel-form-control">
                ...
                @endif
                <form id="user-login" name="user-login" action="{{ route('panel.login') }}" class="panel-form" method="post">
                    @csrf
                    ...
                    <button class="submit-authentication" type="submit" id="submit-auth">ورود</button>


                <div class="auth-link form-control">
                    <label class="custom-radio-button remember-me-inner" for="remember-me">
                        <p>مرا به خاطر بسپار</p>
                        <input type="checkbox" name="remember" id="remember-me" value="1">
                        <span class="post-type-radio"></span>
                    </label>
                </div>

                <div class="auth-link form-control">
                    <a class="forgot-password" href="{{ route('panel.password.request') }}">رمز خود را فراموش کرده اید؟</a>
                </div>
                <div class="auth-link form-control">
                    <a class="forgot-password" href="{{ route('panel.register') }}">ثبت نام</a>
                </div>
