        ...
        <section class="main__panel__section">
            ...
            @if(session('success'))
                ...
                @endif
                    ...
                    <table class="dt-select-table table table-bordered customTable table-dark">
                        <thead>
                        <tr>
                            <th></th>
                            <th>محتوا</th>
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `<input type="checkbox" class="dt-checkboxes form-check-input mt-0 align-middle" name="comments[]" value="${row.id}">`;
                    },
                    checkboxes: {
                        selectRow: true,
