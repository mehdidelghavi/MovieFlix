    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">نیازمندی ها /</span> ویرایش نیازمندی
            </h4>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">ویرایش نیازمندی</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.requirements.update", ['requirement' => $requirement->id]) }}" class="needs-validation form-repeater" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">عنوان نیازمندی</span>
                                  <input type="text" value="{{ old('title', $requirement->title) }}" aria-label="title" id="bs-validation-name" placeholder="عنوان نیازمندی" name="title" class="form-control" required>
                                ...
                                <div class="input-group mb-3">
                                  <span class="input-group-text">متن نیازمندی</span>
                                  <textarea class="form-control" id="editor" name="text" placeholder="درباره مقاله" required>{{ old('text', $requirement->text) }}</textarea>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">آیکون نیازمندی</span>
                                  <input type="text" value="{{ old('icon', $requirement->icon) }}" aria-label="icon" id="bs-validation-name" placeholder="آیکون نیازمندی" name="icon" class="form-control" required>
                                ...
                                <div data-repeater-list="group-a">
                                    ...
                                    <div data-repeater-item>
                                      <div class="row">
                                        <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                          ...
                                          <input type="text" id="form-repeater-1-1" value="{{ $files->title }}" class="form-control text-start" placeholder="KMplayer x64" name="title">
                                        </div>
                                        <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                        ...
                                        <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                          ...
                                          <input type="text" id="form-repeater-1-1" class="form-control text-start" placeholder="exe" name="format" value="{{ $files->format }}">
                                        </div>
                                        <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                          <label class="form-label" for="form-repeater-1-4">سایز</label>
                                          <input type="text" id="form-repeater-1-1" class="form-control text-start" placeholder="64 مگابایت" name="size" value="{{ $files->size }}">
                                        </div>
                                  ...
                                  @if ($requirement->files->count() == 0)
                                      ...
                                      <div class="row">
                                        <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                          <label class="form-label" for="form-repeater-1-1">عنوان</label>
                                          <input type="text" id="form-repeater-1-1" value="" class="form-control text-start" placeholder="KMplayer x64" name="title">
                                        </div>
                                        <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                          <label class="form-label" for="form-repeater-1-2">آپلود فایل</label>
                                          <input type="file" id="form-repeater-1-2" class="form-control text-start" name="file">
                                        ...
                                        <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                          <label class="form-label" for="form-repeater-1-3">فرمت فایل</label>
                                          <input type="text" id="form-repeater-1-1" class="form-control text-start" placeholder="exe" name="format" value="">
                                        </div>
                                        <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                          <label class="form-label" for="form-repeater-1-4">سایز</label>
                                          <input type="text" id="form-repeater-1-1" class="form-control text-start" placeholder="64 مگابایت" name="size" value="">
                                        </div>
