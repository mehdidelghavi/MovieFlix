    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">مقاله ها /</span> ویرایش مقاله
            </h4>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">ویرایش مقاله</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.articles.update", ['article' => $article->id]) }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">عنوان مقاله</span>
                                  <input type="text" value="{{ old('title', $article->title) }}" aria-label="title" id="bs-validation-name" placeholder="عنوان مقاله" name="title" class="form-control" required>
                                ...
                                <div class="input-group mb-3">
                                  <span class="input-group-text">متن مقاله</span>
                                  <textarea class="form-control" id="editor" name="text" placeholder="درباره مقاله" required>{{ old('about', $article->text) }}</textarea>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">برچسب های مقاله</span>
                                  <input id="TagifyBasic" class="form-control" name="tags" value="{{  old('tags', implode(',', $article->tags)) }}">
                                </div>
