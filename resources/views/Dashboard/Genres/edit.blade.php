    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">ژانر ها /</span> ویرایش ژانر
            </h4>
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.genres.update", ['genre' => $genre->id]) }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">عنوان ژانر</span>
                                  <input type="text" value="{{ old('title', $genre->title) }}" aria-label="title" id="bs-validation-name" placeholder="عنوان ژانر" name="title" class="form-control" required>
                                  <div class="invalid-feedback">لطفا یک نام انتخاب کتید</div>
                                </div>
