    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">کالکشن ها /</span> ویرایش کالکشن
            </h4>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">ویرایش کالکشن</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.collections.update", ['collection' => $collection->id]) }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">عنوان کالکشن</span>
                                  <input type="text" value="{{ old('name', $collection->name) }}" aria-label="name" id="bs-validation-name" placeholder="نام کالکشن" name="name" class="form-control" required>
