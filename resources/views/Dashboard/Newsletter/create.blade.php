    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">خبرنامه ها /</span> ارسال خبرنامه
            </h4>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">ارسال خبرنامه</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.newsletter.send") }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">عنوان خبرنامه</span>
                                  <input type="text" value="{{ old('title') }}" aria-label="title" id="bs-validation-name" placeholder="عنوان خبرنامه" name="title" class="form-control" required>
                                  <div class="invalid-feedback">در این قسمت فقط عنوان خبرنامه را بنویسید</div>
                                </div>
                                <div class=" mb-3">
                                  <textarea class="form-control" dir="rtl" id="editor" name="content" placeholder="محتوای خبرنامه" required>{{ old('about') }}</textarea>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">لینک</span>
                                  <input type="text" value="{{ old('link') }}" aria-label="title" id="bs-validation-name" placeholder="https://moviefox.test" name="link" class="form-control" required>
                                  <div class="invalid-feedback">در این قسمت فقط لینک را بنویسید</div>
                                </div>
                                <div class="d-grid gap-2 col-12 mx-auto">
                                  <button type="submit" class="btn btn-primary">
                                    <span class="tf-icons bx bx-plus me-1"></span>ارسال
                                  </button>
                                </div>
                            </form>
                        </div>
