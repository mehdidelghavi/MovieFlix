    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">بازیگران /</span> لیست بازیگران
            </h4>

            <div class="row d-flex justify-content-center">
            <div class="card">
                <h5 class="card-header heading-color">لیست بازیگران</h5>
                @if(session('success'))
                    ...
                    <div class="d-flex w-100 justify-content-center align-items-center">
                        <div style="width: 163px">
                            <select id="defaultSelect" class="form-select MProccess">
                                ...
                                <option value="1">حذف گروهی بازیگران</option>
                            </select>
                        </div>
                    </div>
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `<input type="checkbox" class="dt-checkboxes form-check-input mt-0 align-middle" name="actors[]" value="${row.id}">`;
                    },
                    checkboxes: {
                        selectRow: true,
