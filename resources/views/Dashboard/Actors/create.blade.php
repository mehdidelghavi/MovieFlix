    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">بازیگران /</span> افزودن بازیگر
            </h4>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">افزودن بازیگر</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.actors.store") }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">نام و نام خانوادگی</span>
                                  <input type="text" value="{{ old('name') }}" aria-label="First name" id="bs-validation-name" placeholder="نام و نام خانوادگی" name="name" class="form-control" required>
                                  <div class="invalid-feedback">لطفا نام و نام خانوادگی بازیکر را وارد کنید.</div>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">تاریخ تولد</span>
                                  <input type="text" id="bs-datepicker-basic" placeholder="YYYY/MM/DD" class="form-control" name="birthdate" value="{{ old("birthdate") }}" required>
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <textarea class="form-control" name="about" placeholder="درباره بازیگر" required>{{ old('about') }}</textarea>
                                </div>
