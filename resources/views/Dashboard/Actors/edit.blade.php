    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">بازیگران /</span> ویرایش بازیگر
            </h4>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">ویرایش بازیگر</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.actors.update", ['actor' => $actor->id]) }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">نام و نام خانوادگی</span>
                                  <input type="text" value="{{ old('name', $actor->name) }}" aria-label="First name" id="bs-validation-name" placeholder="نام و نام خانوادگی" name="name" class="form-control" required>
                                  <div class="invalid-feedback">لطفا نام و نام خانوادگی بازیکر را وارد کنید.</div>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">تاریخ تولد</span>
                                  <input type="text" value="{{ old("birthdate", $actor->birthdate) }}" id="bs-datepicker-basic" placeholder="YYYY/MM/DD" class="form-control" name="birthdate" required>
                                  <div class="invalid-feedback">لطفا تاریخ تولد بازیگر را انتخاب کنید</div>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">تصویر پروفایل</span>
                                  <input type="file" name="thumbnail" class="form-control">
                                  <div class="invalid-feedback">لطفا عکس بازیگر را انتخاب کنید</div>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">درباره بازیگر</span>
                                  <textarea class="form-control" name="about" placeholder="درباره بازیگر" required>{{ old('about', $actor->birthdate) }}</textarea>
                                </div>
                                <div class="d-grid gap-2 col-12 mx-auto">
                                  <button type="submit" class="btn btn-primary">
                                    <span class="tf-icons bx bx-plus me-1"></span>ویرایش
                                  </button>
                                </div>
                            </form>
                        </div>
