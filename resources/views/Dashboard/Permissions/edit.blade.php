    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">مجوز ها /</span> ویرایش مجوز
            </h4>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="card mb-4">
                      ...
                      @endif
                        <h5 class="card-header heading-color">ویرایش مجوز</h5>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.permissions.update", ['permission' => $permission->id]) }}" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="input-group mb-3">
                                  <span class="input-group-text">نام مجوز</span>
                                  <input type="text" value="{{ old('name', isset($permission) ? $permission->name : "") }}" aria-label="First name" id="bs-validation-name" placeholder="نام" name="name" class="form-control" required>
                                </div>
                                <div class="input-group mb-3">
                                  <span class="input-group-text">سطح مجوز</span>
                                  <input type="text" value="{{ old('guard_name', isset($permission) ? $permission->guard_name : "") }}" aria-label="First name" id="bs-validation-name" placeholder="سطح" name="guard_name" class="form-control">
                                </div>
